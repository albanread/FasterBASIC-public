...
/// True if and only if the basic_source_files field will have nonzero length when
/// calling Compilation.create.
any_basic_source_files: bool,
...
pub const Options = struct {
    ...
    any_basic_source_files: bool = false,
...
pub fn resolve(options: Options) ResolveError!Config {
    ...
    return .{
        ...
        .any_basic_source_files = options.any_basic_source_files,
